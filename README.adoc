...
* https://mvnrepository.com/artifact/org.junit.vintage/junit-vintage-engine[JUnit Vintage Engine 5.6.2]
* https://mvnrepository.com/artifact/org.junit.platform/junit-platform-runner[JUnit Platform Runner 1.6.2]
* https://mvnrepository.com/artifact/org.junit.platform/junit-platform-engine[JUnit Platform Engine 1.6.2]
