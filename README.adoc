...
:apache-groovy-version: 4.0.19
:spock-framework-version: 2.4-M2-groovy-4.0
:groovy-eclipse-complier-plugin-version: 3.9.0
:groovy-eclipse-batch-complier-version: 4.0.19-03
:junit-jupiter-engine-version: 5.10.2
:junit-jupiter-params-version: {junit-jupiter-engine-version}
:junit-platform-runner-version: 1.10.2
