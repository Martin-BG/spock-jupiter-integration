:jdk-version: OpenJDK 14.01
:apache-maven-version: 3.6.3
:apache-groovy-version: 3.0.3
:spock-framework-version: 2.0-M2-groovy-3.0
:groovy-eclipse-complier-plugin-version: 3.6.0-03
:groovy-eclipse-batch-complier-version: 3.0.3-01
...
* JDK **{jdk-version}** (Java version set to **13** in pom.xml)
...
[source,groovy]
include::src/test/resources/SpockConfig.groovy[]
