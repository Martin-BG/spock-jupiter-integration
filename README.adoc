...
:apache-groovy-version: 3.0.9
:spock-framework-version: 2.0-groovy-3.0
:groovy-eclipse-complier-plugin-version: 3.7.0
:groovy-eclipse-batch-complier-version: 3.0.8-01
:junit-jupiter-engine-version: 5.8.0
:junit-jupiter-params-version: {junit-jupiter-engine-version}
:junit-platform-runner-version: 1.8.0
:apache-maven-compiler-plugin-version: {apache-maven-version}
